    ...
    */
    this.messages = {
      ...
      , type: {
          ...
          , alphabets:  "This value should be alphabets."
        }
      ...
      , fixlength:      "This value must be 5 digit"
	  , fixlength10:      "This value must be 10 digit"
    }, 
  ...
  Validator.prototype = {
    ...
    */
    , validators: {
      ...
      , fixlength: function ( val, fix ) {
          return val.length == fix;
        }  
      , fixlength10: function ( val, fix ) {
          return val.length == fix;
        } 

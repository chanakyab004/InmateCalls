 ...
 * 
 */
$('head').append('<link rel="stylesheet" href="../public/stylesheets/font-awesome.min.css" type="text/css" />');
 (function($){

	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow :'<i class="fa fa-angle-double-left first"></i>',  
			prevArrow : '<i	class="fa fa-angle-left prev"></i>',
			lastArrow : '<i class="fa fa-angle-right next"></i> ',
			nextArrow : (new Image()).src="../public/images/cal_forward.gif",
			rowsPerPage : 5,
			currPage : 1,
